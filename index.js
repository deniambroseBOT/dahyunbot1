...
conn.on('credentials-updated', () => {
  ...
  fs.writeFileSync('./deniambrose.json', JSON.stringify(authInfo, null, '\t')) // save this info to a file
})
fs.existsSync('./deniambrose.json') && conn.loadAuthInfo('./deniambrose.json')
